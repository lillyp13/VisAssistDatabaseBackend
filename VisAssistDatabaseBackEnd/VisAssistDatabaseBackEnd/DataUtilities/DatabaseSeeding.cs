...
namespace VisAssistDatabaseBackEnd.DataUtilities
{
    internal class DatabaseSeeding
    {
        public static void seedProjectTable() 
        {
            ...
            {
                connection.Open();
                string sProjectSeedData = @"
                                        INSERT INTO project_table (
                                        ProjectName, CustomerName, CreatedDate, ModifiedDate, JobName, JobNumber, JobCity, JobState,
                                        JobStreetAddress1, JobStreetAddress2, JobZipCode, ControlContractorName, ControlContractorCity, ControlContractorState,
                                        ...
                                        VALUES('North Campus BAS Upgrade', 'Evergreen Health Systems', '2026-01-05', '2026-01-10',
                                        'North Campus Mechanical Renovation', 'EHS-24017', 'Denver', 'CO', '1850 Clarkson St', 'Building C', '80218',
                                        'Rocky Mountain Controls', 'Denver', 'CO', '720 W 10th Ave', 'Suite 400', '80204',
                                        '303-555-9123', 'projects@rmcontrols.com', 'Morrison Engineering', 'Front Range Mechanical',
                                        'J. McCartney', 'A. Simmons', 18);";

                using (SQLiteCommand command = new SQLiteCommand(sProjectSeedData, connection))
                {
        ...
        {
            string sData = @"
                            INSERT INTO files_Table (ProjectID, RevisionID, FileName, FilePath, CreatedDate, LastModifiedDate, Version, Class, DrawingType, WirePrefix, IgnoreWireColor, AllowDuplicateTags, ShowPointData) 
        ...
        {
            string sData = @"INSERT INTO pages_Table (PageName, ProjectID, FileID, PageIndex, CreatedDate, LastModifiedDate, Version, Class, Orientation, Scale) 
